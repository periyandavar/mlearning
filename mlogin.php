...
<body><div  id="loading" style="background-color:#FDFDFF;opacity:1;position:'absolute'"><div  style="background: url('pre.gif') no-repeat center center;width:100%;height:100%">
	...
	<form action="mlogin.php" method="POST" class="login100-form validate-form" >
...
<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						...
						<input type="hidden" name="user" value="super_user"> 
<span class="focus-input100"></span>
  ...
  if (x.type === "password") {
    ...
    x.type = "password";
					...
					<div class="flex-sb-m w-full p-b-30">
						...
						<div>
							<a href="mrecover.php" class="txt1">
								Forgot Password?
							</a>
						</div>
					</div>

...
<br><center>
<h3> Assignments </h3>
<form action="view_assignment.php" method="POST"><h5>Search For Part I Papers</h5>
...
<form action="view_assignment.php" method="POST"><h5>Search For Part IV Papers</h5>
<table border="0" width="850" height="70">
<tr><td style="font-size:14pt;width:150px;">Subject Name</td><td><select name="sbid" style="font-size:14pt;width:450px;"><option>
<?php
...
if(isset($_POST['Go']))
    {
     ...
     $sql='SELECT StaffCode From link where PaperCode="'.$name3.'"';
      ...
      $sql='SELECT url, Topic From assignment where SubjectCode="'.$name3.'"'.'and StaffCode ="'.$sname.'"and ClassCode="'.$name.'" and status="y"' ;
	  ...
	  echo "<h4>".$a."<br><a href='".$b."'>".$b."</a></h4>";
	  }
	  }
	  if($flag==0)
	  {
		  echo"<script>alert('Assignments are not yet uploaded for this unit,..!')</script>";
	  }}
	  else{echo '<h3> '.$sbid."</h3>";
		$sql='SELECT url, Topic From assignment where SubjectCode="'.$name3.'"and status="y"' ;
	  $rt=mysql_query($sql,$link);
	  $num=mysql_num_rows($rt);
   	  for($j=0;$j<$num;$j++)
	  {
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                ...
                                <p class="category">Available Assignments </p>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <table class="table table-striped">
									...
									{
								$sql='SELECT url,topic From Assignment where classcode="'.$gg.'"and staffcode="'.mysql_result($result1,$j,'staffcode').'"and subjectcode="'.mysql_result($result1,$j,'papercode').'" and status="y" limit 0,10';
                        ...
                        <div class="alert alert-success">
                                    ...
                                    <table width="100%"><tr><td width="55%"><b>'.mysql_result($result7,0,'subjectname').'<br>'.$row['topic'] .'</b> </td><td><span><br> <color:orange"><a target="white" href="'.$row['url'].'"> <i class="ti-bell"></i>'.$row['url'].'</a></b></span></td>

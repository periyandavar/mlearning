...
<br><center>
<h3> Photos </h3>
<form action="view_photography.php" method="POST"><h5>Search For Part I Papers</h5>
...
<form action="view_photography.php" method="POST"><h5>Search For Part IV Papers</h5>
<table border="0" width="850" height="70">
<tr><td style="font-size:14pt;width:150px;">Subject Name</td><td><select name="sbid" style="font-size:14pt;width:450px;"><option>
<?php
...
<form action="view_photography.php" method="POST">
<table border="0" width="850" height="70">
<tr><td style="font-size:14pt;width:150px;">Subject Name</td><td><select name="sbid" style="font-size:14pt;width:450px;"><option>
<?php
...
if(isset($_POST['Go']))
    {
	 ...
	 else	 
	 {
      ...
      $sql='SELECT path, Topic From photo where SubjectCode="'.$name3.'"'.'and StaffCode ="'.$sname.'"and ClassCode="'.$name.'" and status="y"' ;
	  ...
	  $b=mysql_result($rt,$j,'path');
	  echo "<h4>".$a."<br><img width='524' height='280' src='".$b."'>"."</img></h4>";
	  }
	  }
	  if($flag==0)
	  {
		  echo"<script>alert('Photos are not yet uploaded for this unit,..!')</script>";
	  }
	  }else{echo '<h3> '.$sbid."</h3>";
	  $sql='SELECT path, Topic From photo where SubjectCode="'.$name3.'" and status="y"' ;
	  $rt=mysql_query($sql,$link);
	  $num=mysql_num_rows($rt);
   	  for($j=0;$j<$num;$j++)
	  {
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                ...
                                <p class="category">Available Photos </p>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <table class="table table-striped">
									...
									{
								$sql='SELECT path,Topic From photo where classcode="'.$gg.'"and staffcode="'.mysql_result($result1,$j,'staffcode').'"and subjectcode="'.mysql_result($result1,$j,'papercode').'" and status="y" limit 0,10';

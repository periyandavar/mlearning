...
<br><center>
<h3> Notes </h3>
<form action="view_notes.php" method="POST"><h5>Search For Part I Papers</h5>
...
<form action="view_notes.php" method="POST"><h5>Search For Part IV Papers</h5>
<table border="0" width="850" height="70">
<tr><td style="font-size:14pt;width:150px;">Subject Name</td><td><select name="sbid" style="font-size:14pt;width:450px;"><option>
<?php
...
<td style="font-size:14pt;width:220px;"> <input  type="submit" name='Go' value='Go'/> </td></tr>	</table></form>
<?php
if(isset($_POST['Go']))
    {
	 ...
	 else	 
	 {
      ...
      $sql='SELECT Notes, Topic From notes where SubjectCode="'.$name3.'"'.'and StaffCode ="'.$sname.'"and ClassCode="'.$name.'" and status="y"' ;
	  ...
	  $b=mysql_result($rt,$j,'notes');
	  echo "<h4>".$a."<br><a a target='white' href='".$b."'>".$b."</a></h4>";
	  }
	  }
	  if($flag==0)
	  {
	 ...
	 }else{$sql='SELECT Notes, Topic From notes where SubjectCode="'.$name3.'" and status="y"' ;
	  $rt=mysql_query($sql,$link);
	  $num=mysql_num_rows($rt);
   	  for($j=0;$j<$num;$j++)
	  {
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                ...
                                <p class="category">Available Notes </p>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <table class="table table-striped">
									...
									{
								$sql='SELECT notes,topic From notes where classcode="'.$gg.'"and staffcode="'.mysql_result($result1,$j,'staffcode').'"and subjectcode="'.mysql_result($result1,$j,'papercode').'" and status="y" limit 0,10';
                        ...
                        <div class="alert alert-success">
                                    ...
                                    <span><b> '.mysql_result($result7,0,'subjectname').$row['topic'] .'<br> <color:orange"><a target="white" href="'.$row['notes'].'"> <i class="ti-bell"></i>'.$row['notes'].'"</a></b></span>
                     </div></div>   </td>

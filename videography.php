            ...
            <ul class="nav">
                ...
                <li class="active">
                    <a href="videography.php">
                        <i class="ti-export"></i>
                        <p style="font-family:'Charm', cursive; font-size:14px">Videography</p>
                    </a>
                </li>
				<li>
            ...
            <div class="container-fluid">
                <div class="navbar-header">
                    <button type="button" class="navbar-toggle">
                     ...
                     <a class="navbar-brand" style="color:#ffffff;font-family: 'IBM Plex Serif', serif;" href="#">Videography</a>
                </div>
...
<center><center><h3>Add Videos </h3>
<div class="container-fluid"> 
                            <div class="content">
                                    <div class="row">
									    <div class="col-md-2">
										 ...
										 { $sbid=$_POST['sub'];}
									      echo'
                                        <div class="col-md-4">
										<div class="form-group"><form id="myform" action="videography.php" method="POST">
                                               <label>Subject Name</label>
											   <select onchange="submitform1();" name="sub" class="form-control border-input"><option value='.$sbid.'>'.$sbid;
...
if(isset($_POST['Add']))
	...
	elseif(!isset($clid)){
	 ...
	 $clid=$row['ClassCode'];}
      ...
      $query="insert into video (StaffCode,ClassCode,SubjectCode,url,topic,Status) values ('$id','$clid','$sbid','$url','$topic','y')";
	     if((mysqli_query($link,$query)))
		 {
		  echo "<h3>video is added Successfully...!.</h3>";
	     }
		 else{
			 echo"<h3>Error in adding the video,...!</h3>";
		 }
	 }
}
...
<?php
				  if(isset($_POST['eb1']))
				  {
					...
					$id=$_POST[$i];
					$sql='Update video set status="'.$st.'" Where id="'.$id.'" and staffcode="'.$_SESSION['value2'].'"'	;
...
<?php
							if(isset($_POST['eb2']))
				  {
					...
					{
						echo'Unable to Delete the video ,...!';
					}
				  }}
				 ?>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title"> Available Videos </h4>
                                <p class="category">Videos send by us</p>
                            </div>
                            <div class="content table-responsive table-full-width" >
                                <table class="table table-striped">
									...
									<script>
											...
											{
												if(confirm("Are sure you want to delete the Video..?")){
								...
								<?php
									$sql='SELECT  * From video where StaffCode="'.$_SESSION['value2'].'" limit 0,10 ';
								...
								$q1='select subjectname from subject where subjectcode="'.$row['SubjectCode'].'"';
                                        ...
                                        ($rowd=mysqli_fetch_assoc($result1));

...
{  $tuser=$_POST['user'];
    if(isset($_POST['id']))
    {
	 ...
	 if($tuser=="super_admin")
			 {
				 $_SESSION['value1']='SU';
				 $sql='SELECT name,mailid,status From admin Where id="'.$id.'"';
			...
			<div class="wrap-login100">
				...
				<div class="login100-form-title" style="background-image: url(img/bg.jpg);">
					...
					<span class="login100-form-title-1">
						M Learning<br>Recover account<br> (Head)
					</span>
				</div>
                
			<b>																			<center><br><?php if(isset($msg)){echo $msg; } ?> <center>
	<form action="hrecover.php" method="POST" class="login100-form validate-form" >
<?php if(!isset($otp))
echo'

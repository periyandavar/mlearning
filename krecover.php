...
{  $tuser=$_POST['user'];
    if(isset($_POST['id']))
    {
	 ...
	 if($tuser=="super_admin")
			 {
				 $_SESSION['value1']='SU';
				 $sql='SELECT user_name,mail From super_admin Where id="'.$id.'"';
...
else
{
    $msg="Network connection error in sending mail";
	 ...
	 if($pass==$_SESSION['ot'])
	 {
	     ...
	     header('location:sadminedit.php');
	 }
	 else
	 {
...
<body> <div  id="loading" style="background-color:#FDFDFF;opacity:1;position:'absolute'"><div  style="background: url('pre.gif') no-repeat center center;width:100%;height:100%">
			...
			<div class="wrap-login100">
				...
				<div class="login100-form-title" style="background-image: url(img/bg.jpg);">
					...
					<span class="login100-form-title-1">
						M Learning<br>Recover account<br> (king)
					</span>
				</div>
                
			<b>																			<center><br><?php if(isset($msg)){echo $msg; } ?> <center>
	<form action="krecover.php" method="POST" class="login100-form validate-form" >
<?php if(!isset($otp))
echo'
